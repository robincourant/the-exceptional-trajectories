...
from lib.slahmr.slahmr.data import get_dataset_from_cfg, expand_source_paths
from lib.slahmr.slahmr.humor.humor_model import HumorModel
from lib.slahmr.slahmr.optim.base_scene import BaseSceneModel
from lib.slahmr.slahmr.optim.moving_scene import MovingSceneModel
from lib.slahmr.slahmr.optim.optimizers import (
    RootOptimizer,
    SmoothOptimizer,
    SMPLOptimizer,
    # MotionOptimizer,
...
from lib.slahmr.slahmr.optim.output import (
    save_track_info,
    save_camera_json,
    save_input_poses,
    save_initial_predictions,
)
from lib.slahmr.slahmr.vis.viewer import init_viewer

from lib.slahmr.slahmr.util.loaders import (
    load_vposer,
    load_state,
    load_gmm,
...
from lib.slahmr.slahmr.util.logger import Logger
from lib.slahmr.slahmr.util.tensor import get_device, move_to
from lib.slahmr.slahmr.run_vis import run_vis
...
@hydra.main(
    version_base=None,
    config_path="../../lib/slahmr/slahmr/confs",
